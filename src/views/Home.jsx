      ...
      <View style={styles.container}>
        <View>
          {loading ? (
            ...
            // Display your content when loading is false and isAdmin is true
            isAdmin ? (
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ justifyContent: 'center', alignContent: 'center' }}>
                  ...
                  <View style={{ gap: 20, flexDirection: 'row', flex: 1 }}>
                    ...
                    <TouchableOpacity style={styles.gridButtonContainerButtonR} onPress={() => navigation.navigate('Form')}>
