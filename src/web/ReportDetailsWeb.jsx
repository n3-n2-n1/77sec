...
const ReportDetailScreenWeb = ({ route }) => {
    ...
    const generateAndDownloadPDF = async () => {
        const htmlContent = `
          <html>
            ...
            <body>
              <h1>Mi Informe</h1>
              <p>Este es un informe en PDF generado desde una aplicación de React Native con Expo.</p>
            </body>
          </html>
        `;
        ...
        // Ahora `uri` contiene la ruta del PDF generado

        // Puedes usar `uri` para mostrar un enlace o botón para descargar el PDF
        // Por ejemplo, puedes abrir un enlace en un navegador web o utilizar Expo FileSystem para copiarlo a la ubicación deseada en el sistema de archivos del dispositivo.
    };
...
export default ReportDetailScreenWeb;
